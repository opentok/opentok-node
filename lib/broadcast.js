...
*   Maximum time allowed for the broadcast, in seconds.
...
*   The streamMode for the broadcast. If no streamMode is provided it is set to auto by default.
*   Value can be one of the the following:
*   <ul>
*     <li> "auto" -- Video API automatically selects all producers get added to composer
*     <li> "manual" -- customer selects which streams get added to composer
*   </ul>
...
* @see {@link OpenTok#patchBroadcast OpenTok.patchBroadcast()}
* @class Broadcast
*/
var Broadcast = function Broadcast(client, json) {
  ...
  * from the session being broadcastd.
  *
