 ...
 * <a href="https://tokbox.com/account">TokBox account page</a>.)
 *
 * @param env {Object} Configuration options for the client. This parameter is optional.
 * The object contains the following properties, all of which are optional:
 * <p>
 *   <ul>
 *     <li> <code>apiUrl</code> (String) &mdash; Custom URL to use for the API. (For Vonage test use.)</li>
 *     <li> <code>uaAddendum</code> (String) &mdash; String to append to the UserAgent.</li>
 *     <li> <code>timeout</code> (Integer) &mdash; Time in milliseconds to timeout requests.</li>
 *   </ul>
 * </p>
 */
