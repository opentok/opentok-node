...
OpenTok = function (apiKey, apiSecret, env) {
  ...
  */
   ...
   *
   * @param connectionId The connection connection ID of the client you are sending the DTMF signal to.
   *  Leave this empty to send a DTMF signal to all clients connected to the session.
   *
...
/**
  ...
  *     of the published streams in the OpenTok session.
  *   </li>
  *   <li>
  *     <code>observeForceMute</code> (optional) A boolean flag that indicates whether the SIP
  *     end point observes force mute action by other clients like the moderator (<code>true</code>)
