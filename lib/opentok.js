...
OpenTok = function (apiKey, apiSecret, env) {
  ...
  */
   ...
   *
   * @param sessionId {String} The session ID containing the stream.
   *
   * @param streamId {String} The stream ID for the stream to be muted.
   *
   ...
   *
   *   <li>
   *     <code>active</code> (Boolean) &mdash; Whether streams published after
   *     this call, in addition to the current streams in the session, should
