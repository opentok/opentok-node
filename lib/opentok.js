...
OpenTok = function (apiKey, apiSecret, env) {
  ...
  */
   ...
   *      </p>
   *      <>
   *      For HLS, include a single hls property in the outputs object. This object includes
   *      the following optional properties:
   *      <ul>
   *       <li>
   *        dvr (Boolean) — Whether to enable DVR functionality — rewinding, pausing, and
   *        resuming — in players that support it (true), or not (false, the default). With
   *        DVR enabled, the HLS URL will include a ?DVR query string appended to the end.
   *       </li>
   *       <li>
   *        lowLatency (Boolean) — Whether to enable low-latency mode for the HLSstream.
   *        Some HLS players do not support low-latency mode. This feature is incompatible with
   *        DVR mode HLS broadcasts.
   *       </li>
   *      </ul>
   *      The HLS URL is returned in the response and in the REST method for getting information
   *      about a live streaming broadcast.
   *      </p>
   *      <p>
  ...
  */
   ...
   * a session by calling the {@link OpenTok#forceMuteStream OpenTok.forceMuteStream()} method.
   *
