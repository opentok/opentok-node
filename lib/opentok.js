...
var net = require('net'),
    ...
    SipInterconnect = require('./sipInterconnect'),
...
var OpenTok = function(apiKey, apiSecret, env) {
  ...
  *     <li> "createdAt" -- The time the audio stream of the SIP call was created.
  *     <li> "id" -- The unique conference ID of the SIP call.
  *     <li> "projectId" -- The API key that was used to initiate the SIP call.
  *     <li> "sessionId" -- The session ID that the SIP call was added to.
  *     <li> "streamId" -- The stream ID of the audio-only stream representing the SIP call.
  *     <li> "updatedAt" -- The last time the SIP call was updated.
  *   </ul>
  */
  ...
  this.dial = (function (config, sessionId, token, sipUri, options, callback) {
