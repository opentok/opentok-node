 ...
 * </li>
 * 
 *     <li><code>e2ee</code> (String[true|false]) &mdash;
 * This feature adds an encryption layer by encrypting the media payload at the client to 
 * remain encrypted through the media server when routing media to other clients. You must 
 * enable end-to-end encryption when you create a session.
 * </li>
 *
