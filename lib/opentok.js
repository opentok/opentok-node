...
OpenTok = function (apiKey, apiSecret, env) {
  ...
  */
   ...
   *    layout: {
   *      type: "custom",
   *      styleshee": "the layout stylesheet (only used with type == custom)"
   *    },
   *    maxDuration: 5400,
   *    outputs: {
   *      hls: {},
   ...
   * </pre>
   *
   * All properties of the <code>broadcastOptions</broadcastOptions> object
   * are optional, except for <code>outputs</code>.
   *
   ...
   * <code>broadcast</code>, which is set to a Broadcast object on success.
   */
  OpenTok.prototype.startBroadcast = function (sessionId, options, callback) {
    ...
    this.client.startBroadcast(options, function (err, json) {
  ...
  this.stopBroadcast = function stopBroadcast(broadcastId, callback) {
    ...
    this.client.stopBroadcast(broadcastId, function (err, json) {
  ...
  this.getBroadcast = function getBroadcast(broadcastId, callback) {
    // validate
    this.client.getBroadcast(broadcastId, function (err, json) {
   ...
   * https://tokbox.com/developer/guides/broadcast/live-streaming/#configuring-video-layout-for-opentok-live-streaming-broadcasts
   *
   * @param {String} broadcastId The ID of the broadcast.
   *
   * @param type {String} The layout type. Set this to "bestFit", "pip", "verticalPresentation",
