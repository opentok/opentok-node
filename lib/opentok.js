...
var OpenTok = function OpenTok(apiKey, apiSecret, env) {
  ...
  * @memberof OpenTok
  */
  this.startArchive = archiving.startArchive.bind(null, apiConfig);
  ...
  *
  * @param {String} url The URL that will receive the events.
  *
  * @param callback {Function} The function to call upon completing the operation. Two arguments
  * are passed to the function:
  *
  ...
  *
  *   <li>
  *       <code>callback</code> &mdash; The {@link Callback} object. This object includes properties
  *       defining the callback, including the callback ID.
  *   </li>
  *
  * </ul>
  *
  ...
  *
  * @param {String} callbackId The callback ID of the callback to be unregistered.
  *
  * @param callback {Function} The function to call upon completing the operation. Two arguments
  * are passed to the function:
  *
  ...
  * OpenTok events (webhooks) for your API key.
  *
  * @param callback {Function} The function to call upon completing the operation. Two arguments
  * are passed to the function:
  *
  ...
  *
  *   <li>
  *       <code>callbacks</code> &mdash; A list of {@link Callback} objects, which is
  * an array of callbacks that are registered for OpenTok events (webhooks) for your API key.
  *   </li>
  *
  * </ul>
  *
...
/**
  ...
  * </ul>
  *
  * @return A SipInterconnect object with the following properties:
  *   <ul>
  *     <li> <code>id</code> -- The unique conference ID of the SIP call.
  *     <li> <code>connectionId</code> -- The connection ID of the audio-only stream representing
  *          the SIP call.
