...
/**
  ...
  *
  * @param token(required) The OpenTok token to be used for the Audio Connector connection to the.
  * OpenTok session. You can add token data to identify that the connection is the Audio Connector
  ...
  *   <ul>
  *     <li>
  *       <code>id</code> -- A unique ID identifying the Audio Connector WebSocket connection.
  *     </li>
  *     <li>
  *       <code>connectionId</code> -- The OpenTok connection ID for the Audio Connector
