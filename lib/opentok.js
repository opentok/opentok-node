...
OpenTok = function (apiKey, apiSecret, env) {
  ...
  */
  ...
  /**
  * Updates a {@link Archive} object with addStream
  *
  * @param archiveId {String} The archive ID.
  *
  * @param streamId {String} The stream ID to add to archive.
  *
  * @param archiveOptions {Object} An options with these two properties:
  *
  * <ul>
  *   <li>
  ...
  *
  *   <li>
  *     <code>hasVideo</code> &mdash; Archive the video stream. Default value is true.
  *   </li>
  * </ul>
  *
  ...
  */
  ...
  /**
  * Updates a {@link Archive} object with removeStream
  *
  * @param archiveId {String} The archive ID.
  *
  * @param streamId {String} The stream ID to add to archive.
  ...
  */
  ...
  /**
  * Updates a {@link Broadcast} object with addStream
  *
  * @param broadcastId {String} The archive ID.
  *
  * @param streamId {String} The stream ID to add to archive.
  *
  * @param broadcastOptions {Object} An options parameter with these two properties:
  *
  * <ul>
  *
  *   <li>
  ...
  */
  this.addBroadcastStream = function addBroadcastStream(
    broadcastId, streamId, broadcastOptions, callback) {
    var client = this.client;
  ...
  /**
  * Updates a {@link Broadcast} object with removeStream
  *
  * @param broadcastId {String} The archive ID.
  *
  * @param streamId {String} The stream ID to add to archive.
