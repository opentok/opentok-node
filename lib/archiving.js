...
function Archive(config, properties) {
  ...
  */
  ...
  /**
  * Sets the layout type for the archive. For a description of layout types, see
  ...
  * @memberof Archive
  */
  this.setLayout = function setLayout(type, stylesheet, callback) {
    ot.setArchiveLayout(this.id, type, stylesheet, callback);
  };
}
