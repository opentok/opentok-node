...
describe('Archiving', function () {
  ...
  describe('startArchive', function () {
    ...
    it('should return an Archive', function (done) {
      ...
      opentok.startArchive(session, { name: 'Bob' }, function startArchiveCallback(err, archive) {
        expect(err).toBeNull();
    ...
    it('should work without the options', function (done) {
      ...
      opentok.startArchive(session, function startArchiveCallback(err, archive) {
        expect(err).toBeNull();
        expect(archive).not.toBeNull();
        if (archive) {
    ...
    it('should return an error if session ID is invalid', function (done) {
      ...
      opentok.startArchive('invalidSessionIDIam', {}, function startArchiveCallback(err) {
        expect(err).not.toBeNull();
    ...
    it('should return an error if session is p2p or has no connections', function (done) {
      ...
      opentok.startArchive(session, {}, function startArchiveCallback(err) {
        expect(err).not.toBeNull();
        expect(err.message).toBe('Session not found');
        done();
      });
    ...
    it('should be able to archive with hasVideo to false', function (done) {
      ...
      opentok.startArchive(session, { hasAudio: true, hasVideo: false },
      function startArchiveCallback(err, archive) {
        expect(err).toBeNull();
    ...
    it('should be able to archive if outputMode is individual', function (done) {
      ...
      opentok.startArchive(session, { outputMode: 'individual' }, function startArchiveCallback(err, archive) {
        expect(err).toBeNull();
    ...
    it('should be able to archive if outputMode is composed', function (done) {
      ...
      opentok.startArchive(session, { outputMode: 'composed' }, function startArchiveCallback(err, archive) {
        expect(err).toBeNull();
  ...
  describe('getArchive', function () {
    ...
    it('should allow archives with paused status', function (done) {
      ...
      opentok.getArchive(archiveID, function getArchiveCallback(err, archive) {
        expect(err).toBeNull();
        expect(archive).not.toBeNull();
        if (archive) {
    ...
    it('should return an error if archive ID is null', function (done) {
      opentok.getArchive(null, function getArchiveCallback(err) {
        expect(err).not.toBeNull();
    ...
    it('should return an error if archive ID is invalid', function (done) {
      ...
      opentok.getArchive('01614A9B-6BB3-4691-846E-F8A59555AD21', function getArchiveCallback(err) {
        expect(err).not.toBeNull();
  ...
  describe('stopArchive', function () {
    it('should return an archive', function (done) {
      ...
      opentok.stopArchive(archiveId, function stopArchiveCallback(err, archive) {
        expect(err).toBeNull();
        expect(archive).not.toBeNull();
    ...
    it('should return an error if archive ID is invalid', function (done) {
      ...
      opentok.stopArchive('AN-INVALID-ARCHIVE-ID', function stopArchiveCallback(err, archive) {
        expect(archive).toBeUndefined();
        expect(err).not.toBeNull();
        expect(err.message).toBe('Archive not found');
        done();
    ...
    it('should return an error if the archive is not currently started', function (done) {
      ...
      archiveId = 'ca138a6c-380f-4de9-b2b2-bc78b3a117e2';
      opentok.stopArchive(archiveId, function stopArchiveCallback(err, archive) {
        expect(archive).toBeUndefined();
        expect(err).not.toBeNull();
  ...
  describe('deleteArchive', function () {
    it('should return no error on success', function (done) {
      ...
      archiveId = 'ca138a6c-380f-4de9-b2b2-bc78b3a117e2';
      opentok.deleteArchive(archiveId, function deleteArchiveCallback(err) {
        expect(err).toBeNull();
        done();
      });
    });
    ...
    it('should return an error if archive ID is null', function (done) {
      opentok.deleteArchive(null, function deleteArchiveCallback(err) {
        expect(err).not.toBeNull();
        expect(err.message).toBe('No archive ID given');
        done();
      });
    ...
    it('should return an error if archive ID is invalid', function (done) {
      ...
      opentok.deleteArchive('AN-INVALID-ARCHIVE-ID', function deleteArchiveCallback(err) {
        expect(err).not.toBeNull();
        expect(err.message).toBe('Archive not found');
        done();
      });
