...
describe('Callbacks', function() {
  ...
  var CALLBACK = { id: CALLBACK_ID, group: GROUP, event: EVENT, url: URL, createdAt: CREATED_AT };
  ...
  describe('registerCallback', function() {
    ...
    describe('valid responses', function() {
      ...
      it('should return a Callback', function(done) {
        opentok.registerCallback({group: GROUP, event: EVENT, url: URL}, function(err, callback) {
      ...
      it('should fail for missing group', function(done) {
        opentok.registerCallback({event: EVENT, url: URL}, function(err, callback) {
      ...
      it('should fail for missing event', function(done) {
        opentok.registerCallback({group: GROUP, url: URL}, function(err, callback) {
          expect(err).to.not.be.null;
          done();
        });
      });
      ...
      it('should fail for missing url', function(done) {
        opentok.registerCallback({group: GROUP, event: EVENT}, function(err, callback) {
          expect(err).to.not.be.null;
          done();
        });
      });
